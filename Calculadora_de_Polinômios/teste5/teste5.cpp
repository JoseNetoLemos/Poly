    ...
    int main(void)
    {
      ...
      if (Result == -P2A) cout << "OK vazio-polinomio\n";
        ...
        else cout << P2A << " + " << P3 << " = " << Result << " (verifique se está correto)\n";
      ...
      cout << P3 << " - " << P2A << " = " << Result << " (verifique se estah correto)\n";
        ...
        Result = P2A + P2B;
        cout << P2A << " + " << P2B << " = " << Result << '\t';
        if (Result.getGrau() != std::max(P2A.getGrau(), P2B.getGrau())) cerr << "ERRO no grau de polinomio2+polinomio2 com reducao\n";
