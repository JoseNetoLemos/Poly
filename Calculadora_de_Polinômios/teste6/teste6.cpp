...
int main(void)
{
  ...
  cout << P3 << " * " << P2 << " = " << Result << " (verifique se estah correto)\n";
   ...
   // Testando divisão de polinomio2 por polinomio3
    std::pair<Poly, Poly> divisao = P2 / P3;
    cout << "Quociente da divisão de " << P2 << " por " << P3 << " = " << divisao.first << endl;
    cout << "Resto da divisão de " << P2 << " por " << P3 << " = " << divisao.second << endl;
